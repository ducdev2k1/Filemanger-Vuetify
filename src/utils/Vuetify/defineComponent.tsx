...
// Utilities
import { consoleWarn } from '@/utils/Vuetify/console';
import { pick } from '@/utils/Vuetify/helpers';
import { propsFactory } from '@/utils/Vuetify/propsFactory';
import {
...
export type SlotsToProps<U extends RawSlots, T = MakeInternalSlots<U>> = {
  $children?: VNodeChild | (T extends { default: infer V } ? V : {}) | { [K in keyof T]?: T[K] };
...
> = <
  ...
  III = InstanceType<T>,
  P = III extends Record<'$props', any> ? Omit<PropsOptions, keyof III['$props']> : PropsOptions,
...
export function genericComponent<Slots extends RawSlots>(exposeDefaults?: boolean): DefineComponentWithSlots<Slots>;
...
> {
  filterProps<T extends Partial<Props>, U extends Exclude<keyof Props, Exclude<keyof Props, keyof T>>>(
    props: T,
  ): Partial<Pick<T, U>>;
}
