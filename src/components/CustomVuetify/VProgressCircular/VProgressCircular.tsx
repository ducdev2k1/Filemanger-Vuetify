...
// Utilities
import { convertToUnit, genericComponent, propsFactory, useRender } from '@/utils/Vuetify';
  ...
  setup(props, { slots }) {
    ...
    useRender(() => (
      <props.tag
        ...
        {slots.default && (
          <div class="v-progress-circular__content">{slots.default({ value: normalizedValue.value })}</div>
        )}
      </props.tag>
    ));
