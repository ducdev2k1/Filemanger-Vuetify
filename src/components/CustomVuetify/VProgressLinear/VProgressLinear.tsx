...
// Utilities
import { clamp, convertToUnit, genericComponent, IN_BROWSER, propsFactory, useRender } from '@/utils/Vuetify';
...
export const VProgressLinear = genericComponent<VProgressLinearSlots>()({
  ...
  setup(props, { slots }) {
    ...
    const { backgroundColorClasses: bufferColorClasses, backgroundColorStyles: bufferColorStyles } = useBackgroundColor(
