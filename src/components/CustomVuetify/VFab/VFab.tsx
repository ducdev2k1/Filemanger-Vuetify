...
// Components
import { makeVBtnProps, VBtn } from '@/components/CustomVuetify/VBtn';
...
// Utilities
import { genericComponent, omit, propsFactory, useRender } from '@/utils/Vuetify';
      ...
      return (
        <div
          ...
          <div class="v-fab__container">
            <MaybeTransition appear={props.appear} transition={props.transition}>
              <VBtn
                v-show={props.active}
                ref={resizeRef}
                {...btnProps}
