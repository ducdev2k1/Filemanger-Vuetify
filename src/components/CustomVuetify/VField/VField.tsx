      ...
      (val) => {
        if (hasFloatingLabel.value) {
          ...
          requestAnimationFrame(() => {
            ...
            const width = Math.abs(targetWidth - rect.width) > 1 ? { maxWidth: convertToUnit(targetWidth) } : undefined;
        ...
        <div
          ...
          {hasPrepend && (
            <div key="prepend" class="v-field__prepend-inner">
              {props.prependInnerIcon && <InputIcon key="prepend-icon" name="prependInner" color={iconColor.value} />}
          ...
          <div class="v-field__field" data-no-activator="">
            ...
            {slots.default?.({
              ...
              focus,
              blur,
            } as VFieldSlot) ?? <div id={id.value} class="v-field__input" aria-describedby={messagesId.value} />}
          </div>
              ...
              <div
                ...
                <VDefaultsProvider
                  ...
                  {slots.clear ? (
                    ...
                    <InputIcon name="clear" onFocus={focus} onBlur={blur} />
                  )}
                </VDefaultsProvider>
              </div>
            </VExpandXTransition>
          ...
          {hasAppend && (
            <div key="append" class="v-field__append-inner">
              ...
              {props.appendInnerIcon && <InputIcon key="append-icon" name="appendInner" color={iconColor.value} />}
            </div>
          )}

          <div class={['v-field__outline', textColorClasses.value]} style={textColorStyles.value}>
            {isOutlined && (
              <>
