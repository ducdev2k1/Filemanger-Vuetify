...
// Components
import { VAvatar } from '@/components/CustomVuetify/VAvatar';
import { VDefaultsProvider } from '@/components/CustomVuetify/VDefaultsProvider';
import { VIcon } from '@/components/CustomVuetify/VIcon';
...
// Utilities
import { deprecate, EventProp, genericComponent, propsFactory, useRender } from '@/utils/Vuetify';
...
export const VListItem = genericComponent<VListItemSlots>()({
  ...
  setup(props, { attrs, slots, emit }) {
    ...
    const isSelectable = computed(
      () => !!list && (root.selectable.value || root.activatable.value || props.value != null),
    );
    const isClickable = computed(
      () => !props.disabled && props.link !== false && (props.link || link.isClickable.value || isSelectable.value),
    );
        ...
        <Tag
            ...
            <div key="prepend" class="v-list-item__prepend">
              {!slots.prepend ? (
                <>
                  ...
                  {props.prependIcon && <VIcon key="prepend-icon" density={props.density} icon={props.prependIcon} />}
                </>
              ) : (
                <VDefaultsProvider
          ...
          {hasAppend && (
            <div key="append" class="v-list-item__append">
              {!slots.append ? (
                <>
                  {props.appendIcon && <VIcon key="append-icon" density={props.density} icon={props.appendIcon} />}
