...
import type { GenericProps, SelectItemKey } from '@/utils/Vuetify';
...
export const VList = genericComponent<
  new <T extends readonly any[], S = unknown, O = unknown>(
    props: {
      items?: T;
...
>()({
  ...
  setup(props, { slots }) {
    ...
    function onFocus(e: FocusEvent) {
      if (!isFocused.value && !(e.relatedTarget && contentRef.value?.contains(e.relatedTarget as Node))) focus();
    }
    ...
    useRender(() => {
      return (
        <props.tag
          ...
          <VListChildren items={items.value} returnObject={props.returnObject} v-slots={slots} />
        </props.tag>
      );
    });
