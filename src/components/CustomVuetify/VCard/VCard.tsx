        ...
        <Tag
          ...
          {hasImage && (
            <div key="image" class="v-card__image">
              {!slots.image ? (
                <VImg key="image-img" cover src={props.image} />
              ) : (
                <VDefaultsProvider
                  key="image-defaults"
          ...
          {hasText && <VCardText key="text">{slots.text?.() ?? props.text}</VCardText>}

          {slots.default?.()}

          {slots.actions && <VCardActions v-slots={{ default: slots.actions }} />}
