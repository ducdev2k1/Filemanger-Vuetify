...
export const VCardItem = genericComponent<VCardItemSlots>()({
  ...
  setup(props, { slots }) {
    useRender(() => {
      ...
      return (
        <div class={['v-card-item', props.class]} style={props.style}>
          {hasPrepend && (
          ...
          <div class="v-card-item__content">
            {hasTitle && <VCardTitle key="title">{slots.title?.() ?? toDisplayString(props.title)}</VCardTitle>}

            {hasSubtitle && (
              <VCardSubtitle key="subtitle">{slots.subtitle?.() ?? toDisplayString(props.subtitle)}</VCardSubtitle>
            )}
