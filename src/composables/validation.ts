...
// Utilities
import { getCurrentInstance, getCurrentInstanceName, propsFactory, wrapInArray } from '@/utils/Vuetify';
import {
  computed,
  nextTick,
  onBeforeMount,
...
// Types
import type { EventProp, MaybeRef } from '@/utils/Vuetify';
...
export function useValidation(
  ...
  useToggleScope(
    () => validateOn.value.input || (validateOn.value.invalidInput && isValid.value === false),
    () => {
