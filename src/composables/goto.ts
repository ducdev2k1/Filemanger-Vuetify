// Utilities
import { clamp, consoleWarn, mergeDeep, refElement } from '@/utils/Vuetify';
...
export function createGoTo(options: GoToOptions | undefined, locale: LocaleInstance & RtlInstance): GoToInstance {
  return {
    rtl: locale.isRtl,
...
export function useGoTo(_options: GoToOptions = {}) {
  ...
  async function go(target: ComponentPublicInstance | HTMLElement | string | number, options?: Partial<GoToOptions>) {
 ...
 */
function clampTarget(container: HTMLElement, value: number, rtl: boolean, horizontal: boolean) {
