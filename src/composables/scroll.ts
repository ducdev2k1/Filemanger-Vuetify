// Utilities
import { clamp, consoleWarn, propsFactory } from '@/utils/Vuetify';
...
export function useScroll(props: ScrollProps, args: ScrollArguments = {}) {
  ...
  const onScroll = () => {
    ...
    const currentScrollHeight =
      targetEl instanceof Window ? document.documentElement.scrollHeight : targetEl.scrollHeight;
