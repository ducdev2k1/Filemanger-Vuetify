// Utilities
import { consoleError, isObject } from '@/utils/Vuetify';
import { h, mergeProps, render, resolveComponent } from 'vue';

// Types
import type { ComponentInstance } from '@/utils/Vuetify';
import type {
  Component,
...
export function useDirectiveComponent<C extends Component, Props = Omit<ComponentInstance<C>['$props'], ExcludeProps>>(
  component: string | C,
...
function mountComponent(
  ...
  return function (el: HTMLElement, binding: DirectiveBinding, vnode: VNode) {
    ...
    node.appContext = Object.assign(Object.create(null), (binding.instance as ComponentPublicInstance).$.appContext, {
      provides,
    });
